...
| [`apex-corp-price.user.js`](https://raw.githubusercontent.com/stokovich/prun-scripts/main/apex-corp-price.user.js) | 3.6 | Shows the corp price for both regions, `MOR : 1,234.56 / HUB : 1,300.00`, in place order (CXPO), CX material info (CXM), material (MAT) and order book (CXOB) | - |
